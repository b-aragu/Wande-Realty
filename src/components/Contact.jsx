    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-8">
        ...
        <div className="flex items-center space-x-2">
          ...
          <a
            href="https://www.instagram.com/wande_realty/"
            target="_blank"
        ...
        <div className="flex items-center space-x-2">
          ...
          <a
            href="https://www.facebook.com/share/1AhMXF9zmK/?mibextid=wwXlfr"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm text-gray-600 break-words sm:text-base"
          >
        ...
        <div className="flex items-center space-x-2">
          ...
          <a
            href="https://twitter.com/Wande_Realty"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm text-gray-600 break-words sm:text-base"
          >
        ...
        <div className="flex items-center space-x-2">
          ...
          <a
            href="https://www.tiktok.com/@wanderealty"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm text-gray-600 break-words sm:text-base"
          >
